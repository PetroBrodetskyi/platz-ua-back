...
export const verifyEmail = ctrlWrapper(async (req, res) => {
    ...
    <div style="display: flex; justify-content: center; align-items: center; height: 100vh; background-color: #f3f4f6;">
        <div style="text-align: center; padding: 20px; border-radius: 8px; background-color: #fff; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            <h1 style="color: #2d3748; font-family: Arial, sans-serif;">Ваш e-mail підтверджено</h1>
